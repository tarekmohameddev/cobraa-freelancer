...
export const SIM_BUTTONS: Array<{
  ...
  { key: 1, action: 'ai', label: 'AI chat', hint: 'Click / double', signature: 'hid:248A:CA08:st26:1' },
...
export const DEFAULT_SIM_BINDINGS: Record<string, MouseAction> = Object.fromEntries(
  SIM_BUTTONS.map((b) => [b.signature, b.action])
)
